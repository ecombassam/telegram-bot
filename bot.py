...
async def on_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if q.data == CB_MORE_INFO:
        text = (
            ...
            "• 📈 4 استراتيجيات لتحقيق عوائد 8–15% شهريًا.\n"
    ...
    # 📈 برنامج الاستراتيجيات المتقدمة
        ...
        text = (
      "📈 تفاصيل برنامج الاستراتيجيات المتقدمة:\n"
      "دخل شهري مستقر من السوق الأمريكي بدون مضاربات ولا متابعة يومية مرهقة؟\n\n"
      "🚀 البرنامج التدريبي للاستراتيجيات المتقدمة\n\n"
      "خطواتك الذكية لبناء دخل شهري مستقر من سوق الأوبشن\n\n\n"
            "🚀 الاستراتيجيات المتقدمة\n"
            "📌 المميزات:\n"
            "• 🎥 11 درس مسجّل خطوة بخطوة.\n"
            "• 📈 4 استراتيجيات لتحقيق عوائد شهريًا.\n"
            "• 🔒 تطوير الكوفر كول كدخل ثابت.\n"
            "• ⚡️ شرح الكريدت (كول + بوت).\n"
            "• 🛡️ حماية رأس المال.\n\n"
            "🎯 النتيجة:\n"
